...
<div class="modal fade" id="modal_resource_edit" data-backdrop="static">
    <div class="modal-dialog modal-hg">
        <div class="modal-content border-none">
                    ...
                    <form id="form_condition" name="form_condition"
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <input type="text" class="form-control" id="i_id1" readonly>
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <input type="text" class="form-control" id="i_name1">
                                </div>
                            </div>
                        </div>
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <input type="text" class="form-control" id="i_code1">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-group" hidden>
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" id="i_parent1" readonly>
                            </div>
                        </div>
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <textarea class="form-control" id="tt_desc1"></textarea>
                                </div>
                            </div>
                        </div>
                    </form>
            ...
            <div class="modal-footer" style="clear: both;">
                <button type="button" class="btn btn-primary" id="btn_save1">
